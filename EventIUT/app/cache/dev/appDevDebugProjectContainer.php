...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'kartxila.iutbayonne.univ-pau.fr', 'port' => NULL, 'dbname' => 'tlarzabal', 'user' => 'tlarzabal', 'password' => 'tlarzabal', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\EventIUT\\SalonsBundle\\Resources\\config\\doctrine') => 'EventIUT\\SalonsBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'EventIUT\\SalonsBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('EventIUTSalonsBundle' => 'EventIUT\\SalonsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0239059e5b3ef1f1886ed45415d0c5d14c892c18713b621c3fb996a4a4859fad');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EventIUT\\SalonsBundle/Resources/views'), 'EventIUTSalons');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('569e994549f3c')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EventIUTSalonsBundle' => 'EventIUT\\SalonsBundle\\EventIUTSalonsBundle',
            ...
            'database_host' => 'kartxila.iutbayonne.univ-pau.fr',
            'database_port' => NULL,
            'database_name' => 'tlarzabal',
            'database_user' => 'tlarzabal',
            'database_password' => 'tlarzabal',
